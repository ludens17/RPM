...
namespace RPM.app
{
    ...
    public partial class agensEntities : DbContext
    {
        public agensEntities()
            : base("name=agensEntities")
        {
        }
        ...
        public static agensEntities _context;
        public static agensEntities GetContext()
        {
            if (_context == null)
            { _context = new agensEntities(); }
            return _context;
        }
